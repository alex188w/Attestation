...
import HumanFriends.Model.AbstractPackAnimals;

public class Camel extends AbstractPackAnimals {

    public Camel(int id, String name, Date birthday, String commands) {
